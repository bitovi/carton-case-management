...
- TypeScript 5.x with strict mode enabled (001-comment-voting)
- SQLite database via Prisma ORM (schema in `packages/shared/prisma/schema.prisma`) (001-comment-voting)
...
## Recent Changes
- 001-comment-voting: Added TypeScript 5.x with strict mode enabled
