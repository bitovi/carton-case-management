...
```bash
node .claude/skills/react-to-figma-dom/3-extract-assets/extract-icons.js <sourceRoot> --output .temp/react-to-figma
```
...
```bash
node .claude/skills/react-to-figma-dom/3-extract-assets/extract-static-assets.js <clientDir> --output .temp/react-to-figma
```
