...
CREATE TABLE "Case" (
    ...
    CONSTRAINT "Case_updatedBy_fkey" FOREIGN KEY ("updatedBy") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
...
-- CreateIndex
CREATE INDEX "Case_updatedBy_idx" ON "Case"("updatedBy");
