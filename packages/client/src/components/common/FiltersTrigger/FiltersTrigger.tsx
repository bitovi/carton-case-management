  ...
  return (
    <button
      ...
      className={cn(
        ...
        selected ? 'bg-gray-200 hover:bg-gray-300' : 'bg-gray-100 hover:bg-gray-200',
        className
      )}
    >
      <div className="flex items-center gap-2">
        ...
        {hasActiveFilters && (
          <Badge variant="primary" roundness="round" className="bg-teal-500 text-white">
            {activeCount}
          </Badge>
        )}
      </div>
      <SvgIcon icon={filterIcon} size="medium" />
    </button>
  );
}
