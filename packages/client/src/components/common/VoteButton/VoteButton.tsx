...
export function VoteButton({
  ...
  const iconFillClass = active ? 'fill-current' : '';
  ...
  const button = (
    <button
      ...
      onClick={onClick}
      className={cn(
        'inline-flex items-center gap-2 px-2 py-1 rounded transition-colors hover:opacity-80',
      ...
      aria-pressed={active}
    >
      <Icon className={cn('h-6 w-6 shrink-0', iconFillClass)} />
