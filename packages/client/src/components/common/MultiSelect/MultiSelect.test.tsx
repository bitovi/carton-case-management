...
describe('MultiSelect', () => {
  describe('Basic Functionality', () => {
    ...
    it('should show count when options are selected', () => {
      render(
        <MultiSelect label="Status" options={mockOptions} value={['option1']} onChange={() => {}} />
      );
    ...
    it('should open popover on click', async () => {
      render(<MultiSelect label="Customer" options={mockOptions} value={[]} onChange={() => {}} />);
    ...
    it('should call onChange when option is toggled', async () => {
      ...
      render(<MultiSelect label="Status" options={mockOptions} value={[]} onChange={onChange} />);
  ...
  describe('Size Variants', () => {
    it.each([['mini' as const], ['small' as const], ['regular' as const], ['large' as const]])(
  ...
  describe('Decorations', () => {
    it('should render left decoration', () => {
      render(
        <MultiSelect
          label="Test"
          leftDecoration={<SvgIcon icon={userIcon} size="small" data-testid="user-icon" />}
          options={mockOptions}
          value={[]}
          onChange={() => {}}
        />
