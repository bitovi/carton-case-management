...
|----------|-------|----------------|------|--------|
| Button Configuration | Fixed "Label" text | Configurable via props | AlertDialog.tsx | Support different dialog scenarios (delete, confirm, etc.) |
...
| Figma Element | React Prop | Default Variant | Notes |
|---------------|------------|-----------------|-------|
| Primary Button | `actionButton` or `actionLabel` | Default (primary) | Dark navy background (#0f172a) |
| Secondary Button | `cancelButton` or `cancelLabel` | Outline | White background with border |
