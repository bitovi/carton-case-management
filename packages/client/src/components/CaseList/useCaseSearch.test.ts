...
const mockCases = [
  { id: '1', title: 'First Case', createdAt: '2024-01-15T12:00:00.000Z' },
  { id: '2', title: 'Second Case', createdAt: '2024-01-17T12:00:00.000Z' },
] as CaseListItem[];
...
describe('useCaseSearch', () => {
  ...
  it('filters cases by case number', () => {
    ...
    act(() => {
      result.current.setSearchTerm('#CAS-240117-2');
    });
