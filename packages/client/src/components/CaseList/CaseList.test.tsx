...
describe('CaseList', () => {
  ...
  it('filters cases by title as the user types', async () => {
    ...
    await user.type(screen.getByLabelText('Search cases'), 'second');
  ...
  it('filters cases by case number as the user types', async () => {
    ...
    await user.type(screen.getByLabelText('Search cases'), 'CAS-240117');
  ...
  it('shows a message when no cases match the search', async () => {
    ...
    await user.type(screen.getByLabelText('Search cases'), 'no such case');
