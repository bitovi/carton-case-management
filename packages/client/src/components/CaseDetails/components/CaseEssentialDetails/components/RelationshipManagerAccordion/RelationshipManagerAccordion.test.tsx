...
describe('RelationshipManagerAccordion', () => {
  it('renders with items', () => {
    render(<RelationshipManagerAccordion accordionTitle="Related Cases" items={mockItems} />);
    expect(screen.getByText('Related Cases')).toBeInTheDocument();
  });

  it('starts closed by default', () => {
    const { container } = render(<RelationshipManagerAccordion accordionTitle="Related Cases" items={mockItems} />);
  ...
  it('starts open when defaultOpen is true', () => {
    render(<RelationshipManagerAccordion accordionTitle="Related Cases" items={mockItems} defaultOpen />);
  ...
  it('applies custom className', () => {
    const { container } = render(
      <RelationshipManagerAccordion accordionTitle="Related Cases" items={mockItems} className="custom-class" />
    );
